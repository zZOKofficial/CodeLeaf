...
public class MainActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		binding.codeleafTitle.setOnLongClickListener(new View.OnLongClickListener() {
			@Override
			public boolean onLongClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "If you have found this, man, get a job!");
				return true;
			}
		});
	}
	...
	private void initializeLogic() {
		...
		binding.credit.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/mono_bold.ttf"), 0);
	}
